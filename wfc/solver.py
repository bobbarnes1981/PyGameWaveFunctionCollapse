...
class TileSet(object):
    ...
    def image(self, tile_name: str) -> dict:
...
class App(object):
    def __init__(self, tileset: TileSet, delay: float, shownumbers: bool) -> None:
    ...
    def resolve_cell(self, r: int, c: int) -> None:
    ...
    def update_allowed_choices(self, cell_to_restrict: Cell, out_direction: str) -> None:
        # if a cell exists in out_direction
        restricter = self.get_cell(cell_to_restrict.r, cell_to_restrict.c, out_direction)
        if restricter != False:
    ...
    def get_cell(self, r: int, c: int, direction: str) -> Cell:
